  ...
  return (
    <div className="flex items-end gap-2 border-t border-border px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3">
      <textarea
        ...
        className={cn(
          'max-h-28 min-h-11 min-w-0 flex-1 resize-none rounded-[var(--radius-md)] border border-border bg-input px-3 py-2.5 text-base outline-none focus-visible:ring-2 focus-visible:ring-ring/40 md:text-sm',
        )}
      />
      <Button
        size="icon"
